...
def main():
    ...
    audio_fpath = r"C:\Users\SmgHima\Desktop\AvatarAI-oct-14\LLMCode\voiceservice\outputaudio\audio.wav" #module_tester.synthesize_audio("this is audio2face testing") #sys.argv[1]
